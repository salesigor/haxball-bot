...
const badass = ['3230302E3135382E3235312E313235']; // malco
...
room.onPlayerChat = function (player, message) {
    ...
    if (["1"].includes(message[0].toLowerCase())) {
        if (message[1] == null){
            var escolha = Number(message[0]);
            if (player.id === teamR[0].id || player.id === teamB[0].id) {
                choosigPlayer (player, escolha)
            }
        }
    }
    if (["2"].includes(message[0].toLowerCase())) {
        if (message[1] == null){
            var escolha = Number(message[0]);
            if (player.id === teamR[0].id || player.id === teamB[0].id) {
                choosigPlayer (player, escolha)
    ...
    if (["3"].includes(message[0].toLowerCase())) {
        if (message[1] == null){
            var escolha = Number(message[0]);
            if (player.id === teamR[0].id || player.id === teamB[0].id) {
                choosigPlayer (player, escolha)
    ...
    if (["4"].includes(message[0].toLowerCase())) {
        if (message[1] == null){
            var escolha = Number(message[0]);
            if (player.id === teamR[0].id || player.id === teamB[0].id) {
                choosigPlayer (player, escolha)
    ...
    if (["6"].includes(message[0].toLowerCase())) {
        if (message[1] == null){
            var escolha = Number(message[0]);
            if (player.id === teamR[0].id || player.id === teamB[0].id) {
                choosigPlayer (player, escolha)
    ...
    if (["7"].includes(message[0].toLowerCase())) {
        if (message[1] == null){
            var escolha = Number(message[0]);
            if (player.id === teamR[0].id || player.id === teamB[0].id) {
                choosigPlayer (player, escolha)
    ...
    if (["8"].includes(message[0].toLowerCase())) {
        if (message[1] == null){
            var escolha = Number(message[0]);
            if (player.id === teamR[0].id || player.id === teamB[0].id) {
                choosigPlayer (player, escolha)
    ...
    if (["9"].includes(message[0].toLowerCase())) {
        if (message[1] == null){
            var escolha = Number(message[0]);
            if (player.id === teamR[0].id || player.id === teamB[0].id) {
                choosigPlayer (player, escolha)
    ...
    if (["10"].includes(message[0].toLowerCase())) {
        if (message[1] == null){
            var escolha = Number(message[0]);
            if (player.id === teamR[0].id || player.id === teamB[0].id) {
                choosigPlayer (player, escolha)
    ...
    if (["11"].includes(message[0].toLowerCase())) {
        if (message[1] == null){
            var escolha = Number(message[0]);
            if (player.id === teamR[0].id || player.id === teamB[0].id) {
                choosigPlayer (player, escolha)
    ...
    if (["12"].includes(message[0].toLowerCase())) {
        if (message[1] == null){
            var escolha = Number(message[0]);
            if (player.id === teamR[0].id || player.id === teamB[0].id) {
                choosigPlayer (player, escolha)
    ...
    if (["13"].includes(message[0].toLowerCase())) {
        if (message[1] == null){
            var escolha = Number(message[0]);
            if (player.id === teamR[0].id || player.id === teamB[0].id) {
                choosigPlayer (player, escolha)
    ...
    if (["14"].includes(message[0].toLowerCase())) {
        if (message[1] == null){
            var escolha = Number(message[0]);
            if (player.id === teamR[0].id || player.id === teamB[0].id) {
                choosigPlayer (player, escolha)
    ...
    if (["15"].includes(message[0].toLowerCase())) {
        if (message[1] == null){
            var escolha = Number(message[0]);
            if (player.id === teamR[0].id || player.id === teamB[0].id) {
                choosigPlayer (player, escolha)
    ...
    if (["16"].includes(message[0].toLowerCase())) {
        if (message[1] == null){
            var escolha = Number(message[0]);
            if (player.id === teamR[0].id || player.id === teamB[0].id) {
                choosigPlayer (player, escolha)
    ...
    if (["17"].includes(message[0].toLowerCase())) {
        if (message[1] == null){
            var escolha = Number(message[0]);
            if (player.id === teamR[0].id || player.id === teamB[0].id) {
                choosigPlayer (player, escolha)
    ...
    if (["18"].includes(message[0].toLowerCase())) {
        if (message[1] == null){
            var escolha = Number(message[0]);
            if (player.id === teamR[0].id || player.id === teamB[0].id) {
                choosigPlayer (player, escolha)
